...
///////////////// Password protect - Add by vpsscript //////////////////////////////////
include '/etc/vpsscript/defaulpassword.php';
...
<html><body>
    ...
    <big>Get username and password in your manage email or in /home/vpsscript-manage-info.txt !</big><br>
    <big>Or Create new username and password:</big><br>
    <big>vpsscript menu ==> Default User & Password</big> <br> <br>
##########################################<br>
##########################################<br><br><br>
     <big>Ban nhap sai Username hoac Password!</big><br>
    <big>Lay thong tin username va password trong email quan ly hoac trong /home/vpsscript-manage-info.txt !</big><br>
    <big>Hoac tao thong tin username va password moi theo duong dan:</big><br>
    <big>vpsscript menu ==> User & Password Mac Dinh</big><br>
</body></html>
EOB;
		exit(1);
	}
